...
Router.get('/', async (req, res) => {
    const data = await Customer.findAllCustomer().then();
...
Router.post('/', (req, res) => {    
    Upload(req, res, (err) => {
        ...
        const { ID, Fullname, DOB, Gender, Phone, Address, Identify, IdentifyNumber, IdentifyDate } = req.body;
